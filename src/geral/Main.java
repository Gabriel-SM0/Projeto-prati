	...
	public static void main(String[] args) {
		...
		while (opcao != 0) {
			...
			case 2:
				...
				continue;
			case 3:
				System.out.println("Insira o numero do usuário que deseja atualizar: ");
				for(Pessoa elemento: lista) {
					System.out.println("Número: " + lista.indexOf(elemento) + "  Nome: " + elemento);
				}
							
				numero=entrada.nextInt();
				lista.remove(numero);
				lista.add(numero, Cadastro());
				continue;
			case 4:
				System.out.println("Insira o numero do usuário que deseja DELETAR: ");
				for(Pessoa elemento: lista) {
					System.out.println("Número: " + lista.indexOf(elemento) + "  Nome: " + elemento);
				}
